...
const theme = {
  ...
  container: {
    ...
    padding: {
      nav: "20px 30px",
      pdpslider: "70px 30px 0px 30px",
      pdpcontent: "30px 30px",
      xs: "130px 30px 160px 30px",
      sm: "130px 30px 160px 30px",
      smd: "130px 30px 160px 30px",
      md: "130px 30px 160px 30px",
      lg: "130px 30px 160px 30px",
      xl: "130px 30px 160px 30px",
      fullvw: "112px 0px 160px 0px",
      mobile: {
        nav: "0px 30px 0px 30px",
        xs: "90px 30px 100px 30px",
        sm: "90px 30px 100px 30px",
        smd: "90px 30px 100px 30px",
        md: "90px 30px 100px 30px",
        lg: "50px 30px 100px 30px",
        xl: "90px 30px 100px 30px",
